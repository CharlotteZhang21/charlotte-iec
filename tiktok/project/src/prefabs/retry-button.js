...
class RetryButton extends Phaser.Group {
    constructor(game, args) {
        ...
        this.button.events.onInputDown.add(function() {
            this.game.scale.setGameSize(document.body.clientWidth * window.devicePixelRatio, document.body.clientHeight * window.devicePixelRatio);

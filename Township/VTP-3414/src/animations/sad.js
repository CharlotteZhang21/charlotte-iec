...
export function preload(game) {
	game.load.spritesheet('sad', PiecSettings.assetsDir + 'sad.png', 302, 302, 47);
}
...
export function play(game, layer) {
	...
	var animations = AnimationsUtil.playAnimations("sad", xPositions, yPositions, delays, loops, 0.5, 10, scales, false, container, game, layer);

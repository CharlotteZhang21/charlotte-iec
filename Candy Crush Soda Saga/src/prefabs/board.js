...
class Board extends Phaser.Group {
    ...
    createMessage() {
        this.message = new Phaser.Sprite(this.game, 0, 0, 'juicy');
    ...
    animateMessage() {
        ...
        var randomMessage = randomPick > .66 ? "juicy" : (randomPick > .33 ? "tasty" : "divine");
    ...
    getRandomColor() {
        ...
        if (randomColor < this.args.chances[0]) {
            ...
            return 6;
        } else if (randomColor < this.args.chances[0] + this.args.chances[1] + this.args.chances[2] + this.args.chances[3] + this.args.chances[4] + this.args.chances[5] + this.args.chances[6]) {
            return 7;
        }
    }
    ...
    isMatch(col, row) {
        return this.isHorizontalMatch(col, row) || this.isVerticalMatch(col, row) || this.handleFishCombo(col, row);
    }
    ...
    playBombSound() {
        var keyName = "bomb",
            src = PiecSettings.assetsDir + 'bomb_sound.mp3',
            args = {
                loop: false,
                volume: 1,
            };
